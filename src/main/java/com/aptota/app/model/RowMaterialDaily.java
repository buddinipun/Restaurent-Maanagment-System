...
/**
 * RowMaterialDaily generated by hbm2java
 */
@Entity
@Table(name = "row_material_daily", catalog = "restaurent_erp")
public class RowMaterialDaily implements java.io.Serializable {
	...
	public RowMaterialDaily() {
	}

	public RowMaterialDaily(Integer itemId, Double dayStartbalance, Double dayEndBalance, Date date,
